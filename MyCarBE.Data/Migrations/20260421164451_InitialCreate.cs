        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customers_Fleets_FleetId",
                        column: x => x.FleetId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VehicleBodyType = table.Column<int>(type: "integer", nullable: false),
                    VehicleUseType = table.Column<int>(type: "integer", nullable: false),
                    Color = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                    CurrentMileage = table.Column<int>(type: "integer", nullable: false),
                    RegistrationHolderFirstName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    RegistrationHolderLastName = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    RegistrationHolderDocumentType = table.Column<int>(type: "integer", nullable: false),
                    RegistrationHolderDocumentNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    RegistrationCertificateNumber = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Vehicles_Owner_XOR", "(\"CustomerId\" IS NOT NULL AND \"FleetId\" IS NULL) OR (\"CustomerId\" IS NULL AND \"FleetId\" IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                name: "DeclaredServiceHistories",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    VehicleId = table.Column<Guid>(type: "uuid", nullable: false),
                    DeclaredDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Description = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                    Workshop = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeclaredServiceHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeclaredServiceHistories_Vehicles_VehicleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    VehicleId = table.Column<Guid>(type: "uuid", nullable: false),
                    CustomerIdAtEntry = table.Column<Guid>(type: "uuid", nullable: true),
                    FleetIdAtEntry = table.Column<Guid>(type: "uuid", nullable: true),
                    MileageAtEntry = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CatalogServiceId = table.Column<Guid>(type: "uuid", nullable: false),
                    NameSnapshot = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
                    DescriptionSnapshot = table.Column<string>(type: "character varying(1000)", maxLength: 1000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkOrderServices_CatalogServices_CatalogServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkOrderStatusChanges_WorkOrders_WorkOrderId",
                        column: x => x.WorkOrderId,
                        principalTable: "WorkOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkOrderId = table.Column<Guid>(type: "uuid", nullable: false),
                    WorkOrderServiceId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkOrderPhotos_WorkOrderServices_WorkOrderServiceId",
                        column: x => x.WorkOrderServiceId,
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { new Guid("00000000-0000-0000-0000-000000000002"), null, "Customer", "CUSTOMER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeclaredServiceHistories_VehicleId",
                table: "DeclaredServiceHistories",
                column: "VehicleId");

            migrationBuilder.CreateIndex(
                name: "IX_Fleets_TaxId",
                table: "Fleets",
                column: "TaxId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderPhotos_WorkOrderServiceId",
                table: "WorkOrderPhotos",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderServices_CatalogServiceId",
