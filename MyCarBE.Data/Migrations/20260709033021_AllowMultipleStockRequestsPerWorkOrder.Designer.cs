...
namespace MyCarBE.Data.Migrations
{
    ...
    [Migration("20260709033021_AllowMultipleStockRequestsPerWorkOrder")]
    partial class AllowMultipleStockRequestsPerWorkOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.Area", b =>
                {
                    ...
                    b.Property<bool>("IsOilArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);

                    b.Property<bool>("IsTireArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false);
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.MaintenanceAlert", b =>
                {
                    ...
                    b.Property<int>("BaselineMileage")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.Sale", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.SaleItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.VehicleBattery", b =>
                {
                    ...
                    b.Property<decimal?>("BoxHeightCm")
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)");

                    b.Property<decimal?>("BoxLengthCm")
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)");

                    b.Property<decimal?>("BoxWidthCm")
                        .HasPrecision(6, 2)
                        .HasColumnType("numeric(6,2)");
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.VehicleBatteryCheck", b =>
                {
                    ...
                    b.Property<int?>("RemainingPercentage")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.VehicleMileageReading", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("VehicleMileageReadings", (string)null);
                });

            modelBuilder.Entity("MyCarBE.Domain.Entities.VehicleOilService", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<int>("ChangedAtKm")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("VehicleOilServices", (string)null);
                });
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.WorkOrderApprovalToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.WorkshopSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("MileageReminderDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(14);
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.SaleItem", b =>
                {
                    b.HasOne("MyCarBE.Domain.Entities.Sale", "Sale")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("MyCarBE.Domain.Entities.WorkOrder", b =>
                {
                    b.HasOne("MyCarBE.Domain.Entities.Customer", "CustomerAtEntry")
                        .WithMany()
                        .HasForeignKey("CustomerIdAtEntry")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("MyCarBE.Domain.Entities.Fleet", "FleetAtEntry")
                        .WithMany()
                        .HasForeignKey("FleetIdAtEntry")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("CustomerAtEntry");

                    b.Navigation("FleetAtEntry");
